...
export default function CheckAvailableBedDetailsSheet({
    visible,
    onClose,
    type,
    joiningDate,
    ...
    // Date Region
    const [dateRegionSheetOpen, setDateRegionSheetOpen] = useState(false);
    const [selectedDateRegion, setSelectedDateRegion] = useState("");
    const [tempDateRegion, setTempDateRegion] = useState("");
        ...
        <>
            <SuccessModal visible={showSuccess} message={message} type={modalType} />
               ...
               <FilterBottomSheet
                ...
                selectedValues={tempSharing ? [tempSharing] : []}
                setSelectedValues={(val) => setTempSharing(val[0])}
                isSingleSelect={true}
                onReset={() => {
                    setTempSharing("")
                    setSelectedSharing("")
            ...
            <FilterBottomSheet
                visible={dateRegionSheetOpen}
                title="Select Date Region"
                options={dateRegionOptions}
                selectedValues={tempDateRegion ? [tempDateRegion] : []}
                setSelectedValues={(val) => setTempDateRegion(val[0])}
                isSingleSelect={true}
                onReset={() => {
                    setTempDateRegion("")
                    setSelectedDateRegion("")
                    setDateRegionSheetOpen(false)
                }}
                onApply={() => {
                    setSelectedDateRegion(tempDateRegion)
                    setDateRegionSheetOpen(false)
                }}
            ...
            <View style={styles.wrapper} pointerEvents="box-none">
                ...
                >
                    ...
                    <View style={{ marginLeft: 20 }}>
                        <Text style={styles.roomTitle}>Check Availability</Text>
                    </View>
                    ...
                    <View style={styles.filterRow}>
                        ...
                        <TouchableOpacity
                            style={[
                                styles.filterBtn,
                                selectedSharing && styles.activeFilter,
                            ]}
                            onPress={() => {
                        ...
                        >
                            ...
                            <Image
                                ...
                                style={[
                                    styles.arrowIcon,
                                    selectedSharing && styles.activeArrow,
                                ]}
                            />
                        </TouchableOpacity>
                        ...
                        <TouchableOpacity
                            style={[
                                styles.filterBtn,
                                selectedDateRegion && styles.activeFilter,
                            ]}
                            onPress={() => {
                                setTempDateRegion(selectedDateRegion);
                                setDateRegionSheetOpen(true);
                            }}
                        >
                            <Text
                                style={[
                            ...
                            >
                                {selectedDateRegion
                                    ? dateRegionOptions.find(
                                        x => x.value === selectedDateRegion,
                                    )?.label
                                    : "Date Region"}
                            </Text>
                            ...
                            <Image
                                ...
                                style={[
                                    styles.arrowIcon,
                                    selectedDateRegion && styles.activeArrow,
                                ]}
                            />
                        </TouchableOpacity>
