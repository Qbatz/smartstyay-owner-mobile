...
import AmenityRejectDetails from "./AmenityRejectSheet"
...
export default function AmenityRequestDetails({
    ...
    const [AmenityRejectShow , setAmenityRejectShow] = useState(false)
    ...
    const handleShowRejectAmenity = () => {
        setAmenityRejectShow(true)
    }
        ...
        <>
            ...
            >
                ...
                <View style={styles.headerRow}>
                    <View>
                        <Text style={styles.title}>{complaint?.complaintTypeName || "Assign Amenity"}</Text>
...
{/* Amenity Requested */}
<Text style={styles.label}>Amenity Requested</Text>
...
<View style={styles.amenityCard}>
  ...
  <TouchableOpacity style={styles.rejectBadge}
   onPress={handleShowRejectAmenity}
  >
...
<Text style={styles.label}>
  Activate from <Text style={{ color: "#EF4444" }}>*</Text>
</Text>
...
<TouchableOpacity style={styles.dropdownBox}>
  ...
  />
            ...
            {AmenityRejectShow && (
        <AmenityRejectDetails
          visible={AmenityRejectShow}
    onClose={() => setAmenityRejectShow(false)}
    onSuccess={(msg) => {
      setAmenityRejectShow(false);
      handleCloseSheet(); 
    }}
        />
      )}
