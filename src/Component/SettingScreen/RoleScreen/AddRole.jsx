...
export default function AddCategorySheet({ onClose, editData }) {
  ...
  const [permState, setPermState] = useState(
    permissions.map(() => ({ add: false, read: false, edit: false, del: false }))
  );
                  ...
                  {permissions.map((p, i) => (
                    <View key={i} style={styles.row}>
                      ...
                      <View style={styles.rightRow}>
                        ...
                        <TickBox checked={permState[i].edit} onPress={() => toggle(i, "edit")} />
                        <TickBox checked={permState[i].del} onPress={() => toggle(i, "del")} />
                      </View>
                    </View>
                  ))}
                </ScrollView>
