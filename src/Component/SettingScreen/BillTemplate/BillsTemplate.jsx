...
export default function BillsTemplate({ handleBank, onChange }) {
  ...
  useEffect(() => {
    ...
    getGlobalBillPdfDetail(activeHostelId).then(r => {
      console.log(r)
      setContactNumber(r?.data?.templates[1]?.invoiceMobileNumber || r.data?.mobile)
      ...
      setInvoiceNotes(r?.data?.templates[1]?.invoiceNotes || null)
      setTerms(r?.data?.templates[1]?.invoiceTermsAndCondition || null)
