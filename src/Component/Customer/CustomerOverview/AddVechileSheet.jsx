...
const SHEET_HEIGHT = height * 0.54;

export default function AddVechileSheet({
    visible,
    onClose,
    ...
    const slotOptions = [
        { value: "P1-01", label: "P1-01" },
        { value: "P1-02", label: "P1-02" },
        { value: "P1-03", label: "P1-03" },
        { value: "P1-04", label: "P1-04" },
    ];

    const [vehicleSlot, setVehicleSlot] = useState(null);
    const [vehicleSlotOpen, setVehicleSlotOpen] = useState(false);
    const [vehicleSlotError, setVehicleSlotError] = useState("");
                    ...
                    >
                        ...
                        >
                            ...
                            <Text style={styles.title}>
                                {hasJobDetails ? "Edit Vechile Details" : "Add Vechile Details"}
                            </Text>
                            ...
                            <View style={{ zIndex: vehicleTypeOpen ? 30 : 1 }}>
                                <TouchableOpacity
                                    ...
                                    <Text
                                        style={[
                                            styles.dropdownText,
                                            !vehicleType && { color: "#9CA3AF" },
                                        ]}>
                                        {vehicleType?.label || "Select Vehicle Type"}
                                    </Text>
                                    ...
                                    <Image
                                        ...
                                        style={[
                                            styles.arrow,
                                            vehicleTypeOpen && { transform: [{ rotate: "180deg" }] },
                                        ]}
                                    />
                                </TouchableOpacity>
                            ...
                            {vehicleNumberError ? <ErrorMessage message={vehicleNumberError} /> : null}

                            <Text style={styles.label}>Vehicle slot number </Text>
                            <View style={{ zIndex: vehicleSlotOpen ? 30 : 1 }}>
                                <TouchableOpacity
                                    style={styles.dropdown}
                                    activeOpacity={0.8}
                                    onPress={() => {
                                        setVehicleSlotOpen(!vehicleSlotOpen);
                                    ...
                                    <Text
                                        ...
                                        style={[
                                            styles.dropdownText,
                                            !vehicleSlot  && { color: "#9CA3AF" },
                                        ]}>
                                        {vehicleSlot?.label || "Select Slot Number"}
                                    </Text>
                                    ...
                                    <Image
                                        ...
                                        style={[
                                            styles.arrow,
                                            vehicleSlotOpen && { transform: [{ rotate: "180deg" }] },
                                        ]}
                                    />
                                </TouchableOpacity>
