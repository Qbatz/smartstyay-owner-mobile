...
import Bills from "../MorePages/Bills/Bills"; 
import AddComponentSheet from "./AddComponetSheet"
...
import BillsActive from "../../Assets/Images/billactive.png";
import BillsInactive from "../../Assets/Images/billblack.png";
...
const icons = {
  Home: { active: HomeActive, inactive: HomeInActive },
  PG: { active: PGActive, inactive: PGInActive },
  Bills: { active: BillsActive, inactive: BillsInactive },
  More: { active: MoreActive, inactive: MoreInActive },
};

function MyTabBar({ state, descriptors, navigation ,  showActionSheet,
  setShowActionSheet,}) {
...
/>
  ...
  {/* <AddButton
    isOpen={showActionSheet}
    onPress={() => setShowActionSheet(prev => !prev)}
